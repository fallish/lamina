L.DGeoJSONLayer = L.GeoJSON.extend({
  options: {
    debug: false,
    light: true,
    usebbox: false,
  ...
  onMoveEnd: function () {
    ...
    var url = urlencoded ? this.options.endpoint + "?" + urlencoded : this.options.endpoint;
...
L.dGeoJSONLayer = function (uOptions, options) {
  return new L.DGeoJSONLayer(uOptions, options);
};
